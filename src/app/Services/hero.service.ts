...
export class HeroService {
  ...
  getHeroes(): Observable<Hero[]> {
    ...
    /** GET heroes from the server anreturns an Observable
     *
    ...
    /**
     *  To catch errors, you "pipe" the observable result from
     *  http.get() through an RxJS catchError() operator.
     */
    .pipe(
    /**
     *  The RxJS tap() operator, which looks at the observable values,
     *  does something with those values, and passes them along. The tap()
